 ...
 * @file     usbd.h
 * @version  V0.10
 * @brief    NDA102 series USB driver header file
 *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. NDA102 series supports 12  hardware endpoint ID. This parameter could be 0 ~ 11.
  *
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. NDA102 series supports 12 endpoint ID. This parameter could be 0 ~ 11.
  *
